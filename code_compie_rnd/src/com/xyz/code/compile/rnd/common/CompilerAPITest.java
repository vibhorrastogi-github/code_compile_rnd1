...
public class CompilerAPITest {
	...
	static String sourceCode = "package com.accordess.ca;" + "class DynamicCompilationHelloWorld{"
	...
	public void doCompilation() {
		 ...
		 */
		CompilationTask compilerTask = compiler.getTask(null, stdFileManager, diagnostics, compilationOptionss, null,
				compilationUnits);
